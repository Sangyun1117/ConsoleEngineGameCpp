...
PauseLevel::PauseLevel()
{
	...
	items.emplace_back(new PauseMenuItem("Resume Game", []() { static_cast<Game&>(Engine::Get()).ToggleMenu(); }));

	items.emplace_back(new PauseMenuItem("Quit Game", []() { Game::Get().Quit(); }));
